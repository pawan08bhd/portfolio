...
export default function BlogifyCard({ project }) {
  return (
    <article className="project-card" id="blogify">
      {/* Card Screenshot Preview */}
      <div className="project-card-image">
        <img
          src={project.screenshotImage}
          alt="Blogify Developer Platform Interface"
          loading="lazy"
        />
      </div>
      ...
      <div className="project-card-content">
        <div className="project-card-header">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: 'var(--text-dim)', fontFamily: 'var(--font-mono)' }}>Node.js • MongoDB</span>
          </div>
